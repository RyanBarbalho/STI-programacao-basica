...
class AvaliadorCodigo:
    ...
    def __init__(self):
        self.modelo_especialista = MODELO_ESPECIALISTA
    
    def avaliar_estatico(self, codigo_aluno, enunciado):
        """
        Avalia estaticamente o código do aluno.
        """
        return avaliador_estatico(codigo_aluno, enunciado)
    
    def avaliar_dinamico(self, codigo_aluno, casos_de_teste):
        """
        Avalia dinamicamente o código do aluno.
        """
        return avaliador_dinamico(codigo_aluno, casos_de_teste)
    
    def avaliar_completo(self, codigo_aluno, enunciado, casos_de_teste):
        """
        Avalia o código de forma completa (estática + dinâmica).
        """
        return avaliador_completo(codigo_aluno, enunciado, casos_de_teste)
...
def avaliador_completo(codigo_aluno, enunciado, casos_de_teste):
    """
    Avalia o código do aluno de forma completa:
    1. Análise estática
    2. Análise dinâmica (se a estática passar)
    """
    
    # 1. Avaliação estática
    resultado_estatico = avaliador_estatico(codigo_aluno, enunciado)
    ...
    resultado_dinamico = avaliador_dinamico(codigo_aluno, casos_de_teste)
